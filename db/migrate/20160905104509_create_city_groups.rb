class CreateCityGroups < ActiveRecord::Migration
  def change
    ...
    # create CityGroup instances
    france = CityGroup.create!(
      name: "France",
      slug: "france",
      icon: '<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 56 40" enable-background="new 0 0 56 40" xml:space="preserve">
              <g>
                <rect fill="#FFFFFF" width="56" height="40"/>
                <rect fill="#3B6AC3" width="18" height="40"/>
                <rect x="38" fill="#FF0000" width="18" height="40"/>
              </g>
              </svg>'
    )
    europe = CityGroup.create!(
      name: "Europe",
      slug: "europe",
      icon: '<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 56 40" enable-background="new 0 0 56 40" xml:space="preserve">
              <g>
                <rect fill="#001468" width="56" height="40"/>
                <path fill="#FFFFFF" d="M56,40h-6L34,27v13H22V27L6,40H0v-4l12-10H0V14h12L0,4V0h6l16,13V0h12v13L50,0h6v4L44,14h12v12H44l12,10V40
                  z"/>
                <path fill="#FF0000" d="M53,40L36,26h5l15,13v1H53z M32,40h-8V24H0v-8h24V0h8v16h24v8H32V40z M36,14L53,0h3v1L41,14H36z M0,1V0h3
                  l17,14h-5L0,1z M20,26L3,40H0v-1l15-13H20z"/>
              </g>
              </svg>'
    )
    brazil = CityGroup.create!(
      name: "Brazil",
      slug: "brazil",
      icon: '<svg xmlns="http://www.w3.org/2000/svg" version="1.0" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-2100 -1470 4200 2940">
                <defs>
    ...
    # create OrderedList for city groups
    OrderedList.create!(
      name: "city_groups",
      element_type: "CityGroup",
      slugs: %w( france europe brazil )
    )
  end
end
