json.city do
  json.extract! @city, :id, :name, :email, :slug, :location, :logistic_specifics, :marketing_specifics, :course_locale, :apply_facebook_pixel, :mailchimp_list_id, :encrypted_mailchimp_api_key, :contact_phone_number, :contact_phone_number_displayed, :contact_phone_number_name
  json.description do
