json.city do
  json.extract! @city, :id, :name, :slug, :location, :logistic_specifics, :marketing_specifics, :course_locale, :apply_facebook_pixel, :mailchimp_list_id, :encrypted_mailchimp_api_key
  json.description do
